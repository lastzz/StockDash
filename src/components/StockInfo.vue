  ...
  <div class="hello">
    <div class="container">
      ...
      <div class="div" v-if="price !==''">
        ...
        <div class="row mt-5">
          <div class="col-md-4">
            <div class="card card-profile boder-0">
        ...
        <div class="row">
          <div class="col-md-12 mt-3 a;ign-center">
  ...
  methods:{
    ...
    getTable(stock) {
      ...
      this.IStemp = '',
       ...
       axios.get(`https://financialmodelingprep.com/api/v3/financials/income-statement/${stock}?period=quarter&apikey=5bc997863fc737135426678ffa3ae3ad`)
       .then(res => {
    ...
    getChartPie(stock) {
      axios.get(`https://financialmodelingprep.com/api/v3/financials/balance-sheet-statement/${stock}?period=quarter&apikey=5bc997863fc737135426678ffa3ae3ad`)
      .then( res => {
    ...
    getChart(stock) {
      axios.get(`https://financialmodelingprep.com/api/v3/historical-price-full/${stock}?timeseries=300&apikey=5bc997863fc737135426678ffa3ae3ad`)
      .then( res => {
        this.open = []
        this.close = []
        this.high = []
...
var layout = {
  ...
  Plotly.plot('CandleStick', data, layout);
    ...
    getcompanyValue(stock) {
      axios.get('https://financialmodelingprep.com/api/v3/financial-ratios/'+stock+'?apikey=5bc997863fc737135426678ffa3ae3ad')
        .then(res => {
    ...
    getInfo(stock){
      console.log(stock)
      axios.get('https://financialmodelingprep.com/api/v3/company/profile/'+stock+'?apikey=5bc997863fc737135426678ffa3ae3ad')
      //axios.get('https://financialmodelingprep.com/api/v3/company/profile/'+stock+'?apikey=demo')
      .then(res => {
